...
from base.implement import Seq_DynamicArray, Seq_LinkedList


class TestSeq_DynamicArray(TestCase):
    def setUp(self) -> None:
        self.n = 100
        self.seq = Seq_LinkedList(range(self.n))
...
class Test(TestCase):
    ...
    def test_bench(self):
        ...
        implementations = {"Seq_DynamicArray": Seq_DynamicArray, "Seq_LinkedList": Seq_LinkedList}
        methods = {
            "build": [(range(n),)] * times,
